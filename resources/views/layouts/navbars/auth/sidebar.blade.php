...
<div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="">
        ...
        <span class="ms-1 font-weight-bold">Eco Mar</span>
      </a>
    </div>
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    ...
    @can('dashboard')
      ...
      @can('raport_dzienny')
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('reports/monthly') ? 'active' : '') }}" href="{{ url('reports/monthly') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>box-3d-50</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Raport miesięczny</span>
        </a>
      </li>
      @endcan
      @can('zlecenia')
      ...
      @can('zlecenia')
       <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('billings') ? 'active' : '') }}" href="{{ url('billings') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>box-3d-50</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
  ...
  <a class="nav-link collapsed" data-bs-toggle="collapse" href="#dropdownExample" role="button" aria-expanded="false" aria-controls="dropdownExample">
    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      <!-- Możesz użyć własnego SVG lub ikony; poniżej przykład z ikoną Font Awesome -->
      <i class="fa-solid fa-user"></i>

    </div>
    <span class="nav-link-text ms-1">Przykładowy Dropdown</span>
  </a>
  <div class="collapse" id="dropdownExample">
